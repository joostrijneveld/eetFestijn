...
def populate_fest(apps, schema_editor):
    ...
    add_item("Margherita", 500, pizzadag25)
    add_item("Bianca", 600, pizzadag25)
    add_item("Napolitana", 650, pizzadag25)
    add_item("Funghi", 650, pizzadag25)
    add_item("Borromea", 650, pizzadag25)
    add_item("Vesuvio", 650, pizzadag25)
    add_item("Peperoni", 650, pizzadag25)
    add_item("Salami", 650, pizzadag25)
    add_item("Romagna", 700, pizzadag25)
    add_item("Siciliana", 800, pizzadag25)
    add_item("Quatro stagioni", 900, pizzadag25)
    add_item("Pollo", 900, pizzadag25)
    add_item("Capricciosa", 900, pizzadag25)
    add_item("Tonno", 850, pizzadag25)
    add_item("Vegetaria", 900, pizzadag25)
    add_item("Spinazie", 900, pizzadag25)
    add_item("Pizza döner speciaal", 950, pizzadag25)
    add_item("Pizza shoarma speciaal", 950, pizzadag25)
    add_item("Pizza shoarma", 900, pizzadag25)
    add_item("Pizza döner kebab", 900, pizzadag25)
    add_item("Estete", 700, pizzadag25)
    add_item("Gorgonzola al fromaggio", 900, pizzadag25)
    add_item("Hawaï", 900, pizzadag25)
    add_item("Campagnola", 850, pizzadag25)
    add_item("Roma", 800, pizzadag25)
    add_item("Carbonara", 900, pizzadag25)

    add_item("Funghi e pesce", 1100, pizzadag2635)
    add_item("Mafiosa", 1000, pizzadag2635)
    add_item("Santa Maria", 1000, pizzadag2635)
    add_item("Paescana speciale", 1000, pizzadag2635)
    add_item("Marinara", 1000, pizzadag2635)
    add_item("Pizza De Fest speciaal", 1100, pizzadag2635)
    add_item("Calzone vegatarisch", 950, pizzadag2635)
    add_item("Calzone shoarma", 1000, pizzadag2635)
    add_item("Calzone kip", 1000, pizzadag2635)
    add_item("Calzone fantasie", 1000, pizzadag2635)
    add_item("Calzone de Fest", 1100, pizzadag2635)
